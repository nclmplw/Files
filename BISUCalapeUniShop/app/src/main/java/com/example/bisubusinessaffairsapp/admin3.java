...
public class admin3 extends AppCompatActivity {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(password.getText().toString())){
                    ...
                    loadingBar.setTitle("Purchased Information");
                    loadingBar.setMessage("Please wait, while we are checking password.");
                    loadingBar.setCanceledOnTouchOutside(false);
                    loadingBar.show();
                    Intent intent = new Intent(admin3.this, purchasedinfo.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.home:
                Intent home= new Intent(admin3.this, home.class);
                startActivity(home);
                break;

            case R.id.product:
                Intent product=new Intent(admin3.this, product.class);
                startActivity(product);
                break;

            case R.id.shop:
                Intent shop= new Intent(admin3.this, shop.class);
                startActivity(shop);
                break;
            ...
            case R.id.customerinfo:
                Intent customerinfo=new Intent(admin3.this, admin.class);
                startActivity(customerinfo);
                break;

            case R.id.admininfo:
                Intent admininfo=new Intent(admin3.this, admin1.class);
                startActivity(admininfo);
                break;

            case R.id.productinfo:
                Intent productinfo=new Intent(admin3.this, admin2.class);
                startActivity(productinfo);
                break;

            case R.id.purchasedinfo:
                Intent purchasedinfo=new Intent(admin3.this,admin3.class);
                startActivity(purchasedinfo);
                break;

            case R.id.aboutus:
                Intent aboutus=new Intent(admin3.this,aboutus.class);
