...
public class admin extends AppCompatActivity {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(password.getText().toString())){
                    ...
                    loadingBar.setTitle("Customer's Information");
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.home:
                Intent home= new Intent(admin.this, home.class);
                startActivity(home);
                break;

            case R.id.product:
                Intent product=new Intent(admin.this, product.class);
                startActivity(product);
                break;

            case R.id.shop:
                Intent shop= new Intent(admin.this, shop.class);
                startActivity(shop);
                break;
            ...
            case R.id.customerinfo:
                Intent customerinfo=new Intent(admin.this, admin.class);
                startActivity(customerinfo);
                break;

            case R.id.admininfo:
                Intent admininfo=new Intent(admin.this, admin1.class);
                startActivity(admininfo);
                break;

            case R.id.productinfo:
                Intent productinfo=new Intent(admin.this, admin2.class);
                startActivity(productinfo);
                break;

            case R.id.purchasedinfo:
                Intent purchasedinfo=new Intent(admin.this,admin3.class);
                startActivity(purchasedinfo);
                break;

            case R.id.aboutus:
                Intent aboutus=new Intent(admin.this,aboutus.class);
